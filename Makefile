...
pkgdatadir = $(datadir)/dhcping
pkglibdir = $(libdir)/dhcping
...
CONFIG_CLEAN_FILES =
bin_PROGRAMS = dhcping$(EXEEXT)
PROGRAMS = $(bin_PROGRAMS)

am_dhcping_OBJECTS = dhcping.$(OBJEXT)
dhcping_OBJECTS = $(am_dhcping_OBJECTS)
dhcping_LDADD = $(LDADD)
dhcping_DEPENDENCIES =
dhcping_LDFLAGS =

DEFS = -DPACKAGE=\"dhcping\" -DVERSION=\"1.2\" -DTIME_WITH_SYS_TIME=1 -DHAVE_NETDB_H=1 -DHAVE_NETINET_IN_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_SYS_SOCKET_H=1 -DHAVE_SYS_TIME_H=1 -DHAVE_UNISTD_H=1 -DHAVE_GETHOSTBYNAME=1 -DHAVE_MEMSET=1 -DHAVE_SELECT=1 -DHAVE_SOCKET=1 
DEFAULT_INCLUDES =  -I. -I$(srcdir)
CPPFLAGS = 
LDFLAGS = 
LIBS = 
depcomp = $(SHELL) $(top_srcdir)/depcomp
DEP_FILES = $(DEPDIR)/dhcping.Po
COMPILE = $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) \
	$(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS)
CCLD = $(CC)
LINK = $(CCLD) $(AM_CFLAGS) $(CFLAGS) $(AM_LDFLAGS) $(LDFLAGS) -o $@
CFLAGS = -g -O2
DIST_SOURCES = $(dhcping_SOURCES)
...
installdirs:
	$(mkinstalldirs) $(DESTDIR)$(bindir) $(DESTDIR)$(man8dir)
